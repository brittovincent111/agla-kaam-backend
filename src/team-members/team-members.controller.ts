...
export class TeamMembersController {
  ...
  @Post()
  create(@CurrentBusiness() business: AuthenticatedBusiness, @Body() dto: CreateTeamMemberDto) {
  ...
  @Patch(':id/activate')
  activate(@CurrentBusiness() business: AuthenticatedBusiness, @Param('id') id: string) {
    return this.teamMembersService.setActive(business.businessId, id, true);
  }

  @Patch(':id/deactivate')
  deactivate(@CurrentBusiness() business: AuthenticatedBusiness, @Param('id') id: string) {
